...
class MovieTopRatedFragment : Fragment() {
    ...
    private var movieTopRatedAdapter: MovieVerticalAdapter? = null
    ...
    override fun onCreateView(
        ...
        val binding = FragmentMovieTopRatedBinding.inflate(inflater, container, false)

        loadingMovieTopRated = binding.loadingMovieTopRatedList
        rvMovieTopRated = binding.rvMovieTopRatedList
        textNoResult = binding.textNoMovieTopRatedResult
    ...
    private fun setTopRatedMovies() {
        movieTopRatedAdapter = MovieVerticalAdapter(movieTopRatedResults, requireContext())
        ...
        if(resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE){
            rvMovieTopRated.layoutManager = mLandscapeLayoutManager
        } else {
            rvMovieTopRated.layoutManager = mPortraitLayoutManager
        }
